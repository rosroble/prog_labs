...
public class AuthCommand extends AbstractCommand {
    ...
    public AuthCommand(String username, String password, AuthType authType) throws DomainViolationException {
        super(CommandType.AUTH);
        if (authType.equals(AuthType.REGISTER)) {
    ...
    private boolean usernameIsCorrect(String username) throws DomainViolationException {
        ...
        if (!match) throw new DomainViolationException("wrongUsername");
        return true;
    }
    ...
    private boolean passwordIsCorrect(String password) throws DomainViolationException {
        ...
        if (!match) throw new DomainViolationException("wrongPassword");
        return true;
    }
