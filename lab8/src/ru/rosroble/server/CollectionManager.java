...
//    }
    ...
    public String toString() {
        return listType + " " + collection.size();
    }
    ...
    public Response add(Ticket t, boolean ifMax) {
        ...
        return new Response("Добавлен объект: " + t.toString(), true);
    }
    ...
    public Response clear(String initiator) {
        ...
        try {
            ...
            Iterator<Ticket> it = temp.iterator();
            while (it.hasNext()) {
                try {
                    Ticket t = it.next();
    ...
    public Response getInfo() {
        Response response = new Response(toString());
        response.setDate(initDate);
        return response;
    }
