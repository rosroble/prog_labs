            ...
            switch (type) {
                ...
                case REMOVE_BY_ID:
                    ...
                    try {
                        ...
                        else return new Response("idNotFound");
                    } catch (SQLException e) {
                        e.printStackTrace();
                        dbHandler.rollback();
                        return new Response("fail", false);
                    } catch (InsufficientPermissionException e) {
                        return new Response("noPermission", false);
                    }
                case UPDATE_ID:
                    ...
                    if (oldT == null) return new Response("idNotFound", false);
                    if(!dbHandler.isOwnerOf(updateIdCommand.getId(), initiator)) return new Response("noPermission", false);
                ...
                case TICKET_SHOWCASE:
                    return new ShowcaseResponse("", true, new ArrayList<Ticket>(manager.getList()));
                default:
                    break;
            }
            ...
            try {
                ...
                if (authCommand.getAuthType().equals(AuthCommand.AuthType.REGISTER)) {
                    if(dbHandler.registerUser(username, password))
                        ...
                        return new Response("userAlreadyExists", false);
                }
                if (authCommand.getAuthType().equals(AuthCommand.AuthType.LOGIN)) {
                    ...
                    else return new Response("invalidCredentials", false);
                }
            } catch (SQLException e) {
                e.printStackTrace();
